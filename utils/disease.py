disease_dic = {
    'Apple___Apple_scab': """ <h3><b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    'Apple___Black_rot': """<h3> <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Apple___Cedar_apple_rust': """ <h3><b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Apple___healthy': """ <h3><b>Crop</b>: Apple <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",




    'Blueberry___healthy': """<h3> <b>Crop</b>: Blueberry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",




    'Cherry_(including_sour)___Powdery_mildew': """ <h3><b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Cherry_(including_sour)___healthy': """ <h3><b>Crop</b>: Cherry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <h3><b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Common_rust_': """ <h3><b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """<h3> <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Grape___Black_rot': """ <h3><b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___healthy': """ <h3><b>Crop</b>: Corn(maize) <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Grape___Esca_(Black_Measles)': """ <h3><b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """<h3> <b>Crop</b>: Grape <br/>Disease: Leaf Blight<br/>
        <br/> Cause of disease:
        <br/><br/> 1. Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.
        <br/> 2. Fungal spores are carried by wind, rain or splashing water from the ground to flowers, leaves or fruit. During damp or rainy periods, newly opening apple leaves are extremely susceptible to infection. The longer the leaves remain wet, the more severe the infection will be. Apple scab spreads rapidly between 55-75 degrees Fahrenheit.
        <br/><br/> How to prevent/cure the disease <br/>
    ...
    'Grape___healthy': """ <h3><b>Crop</b>: Grape <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """<h3><b> Crop</b> : Grape <br/> Disease: Leaf Spot""",


    'Orange___Haunglongbing_(Citrus_greening)': """ <h3><b>Crop</b>: Orange <br/>Disease: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    'Peach___Bacterial_spot': """ <h3><b>Crop</b>: Peach <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Pepper,_bell___Bacterial_spot': """ <h3><b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Peach___healthy': """ <h3><b>Crop</b>: Peach <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """ <h3><b>Crop</b>: Pepper <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___healthy': """ <h3><b>Crop</b>: Potato <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """<h3> <b>Crop</b>: Raspberry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soybean___healthy': """ <h3><b>Crop</b>: Soyabean <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """ <h3><b>Crop</b>: Strawberry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato___healthy': """ <h3><b>Crop</b>: Tomato <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___Early_blight': """ <h3><b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Potato___Late_blight': """<h3> <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
    ...
    'Squash___Powdery_mildew': """ <h3><b>Crop</b>: Squash <br/>Disease: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    'Strawberry___Leaf_scorch': """ <h3><b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Bacterial_spot': """<h3> <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
        <br/><br/> 1. The disease is caused by four species of Xanthomonas (X. euvesicatoria, X. gardneri, X. perforans, and X. vesicatoria). In North Carolina, X. perforans is the predominant species associated with bacterial spot on tomato and X. euvesicatoria is the predominant species associated with the disease on pepper.
        <br/> 2. All four bacteria are strictly aerobic, gram-negative rods with a long whip-like flagellum (tail) that allows them to move in water, which allows them to invade wet plant tissue and cause infection.
        <br/><br/> How to prevent/cure the disease <br/>
    ...
    'Tomato___Early_blight': """<h3> <b>Crop</b>: Tomato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Late_blight': """ <h3><b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': """ <h3><b>Crop</b>: Tomato <br/>Disease: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Septoria_leaf_spot': """<h3> <b>Crop</b>: Tomato <br/>Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ <h3><b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Target_Spo': """ <b>Crop</b>: <h3>Tomato <br/>Disease: Target Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """ <h3><b>Crop</b>: Tomato <br/>Disease: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': """<h3> <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
