fertilizer_dic = {
        'NHigh': """<h2>The N value of soil is high and might give rise to weeds.
        <br/><h2> Please consider the following suggestions:</h4>
        <h3>
        ...
        'Nlow': """<h2>The N value of your soil is low.
        <br/><h2> Please consider the following suggestions:
        <h3><br/><br/> 1. <i>Add sawdust or fine woodchips to your soil</i> – the carbon in the sawdust/woodchips love nitrogen and will help absorb and soak up and excess nitrogen.
        ...
        'PHigh': """<h2>The P value of your soil is high.
        <br/><h2> Please consider the following suggestions:
        <h3><br/><br/>1. <i>Avoid adding manure</i> – manure contains many key nutrients for your soil but typically including high levels of phosphorous. Limiting the addition of manure will help reduce phosphorus being added.
        ...
        'Plow': """<h2>The P value of your soil is low.
        <br/><h2> Please consider the following suggestions:
        ...
        'KHigh': """<h2>The K value of your soil is high.</br>.
        <h2> Please consider the following suggestions:
        <h3><br/><br/>1. <i>Loosen the soil</i> deeply with a shovel, and water thoroughly to dissolve water-soluble potassium. Allow the soil to fully dry, and repeat digging and watering the soil two or three more times.
        ...
        'Klow': """<h2>The K value of your soil is low.
        <br/><h2> Please consider the following suggestions:</h4>
        <h3><br/><br/>1. Mix in muricate of potash or sulphate of potash
